...
\begin{innerlist}
\item Nuclear diagnostics for magnetic fusion 
...
\begin{bibenum}
  \item Z.S. Hartwig and P. Gumplinger, Simulating response functions
    and pulse shape discrimination for organic scintillation detectors
    with Geant4. \emph{Nuclear Instruments and Methods A},
    \textbf{737} (2014) 155-162.

  \item Z.S. Hartwig \emph{et. al}, An in-situ accelerator-based
    diagnostic for plasma-material interactions science on magnetic
    fusion devices, \emph{Review of Scientific Instruments},
    \textbf{84} (2013) 123503.

   \item Z.S. Hartwig, C.B. Haakonsen, R.T. Mumgaard, \emph{et al.} An
     initial study of demountable, high-temperature superconducting
     magnets for the Vulcan tokamak conceptual design.  \emph{Fusion
       Engineering and Design}, \textbf{87} (2012) 201-214.
